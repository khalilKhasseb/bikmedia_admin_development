        ...
        <div class="row layout-spacing layout-top-spacing" id="cancel-row">
            <div class="col-lg-12">
                <div class="panel-body searchable-container" :class="[grid_type]">
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search layout-spacing align-self-center">
                            <form class="form-inline my-2 my-lg-0">
                                <div class="">
                                    ...
                                    <input type="text" v-model.trim="search_text" class="product-search form-control" @input="onSearchInput" placeholder="Search Gifts..." />
                                </div>
                            </form>
                        </div>
                                ...
                                <div class="dropdown me-2">
                                    ...
                                    <ul class="dropdown-menu" style="min-width: 250px; padding: 15px;">
                                        ...
                                        <li>
                                            ...
                                            <select class="form-select" v-model.number="filters.limit" @change="onLimitChange">
                        ...
                        <div v-for="(gift, index) in filterd_gifts_list" class="items" :key="gift.id">
                            <div class="item-content">
                                <div class="user-profile">
                                    <img :src="gift.icon || gift.img || defaultAvatar" alt="gift" style="width: 50px; height: 50px; object-fit: cover; border-radius: 8px;" />
                                    <div class="user-meta-info">
                                        <p class="user-name">{{ gift.name || 'N/A' }}</p>
                                ...
                                <div class="user-location">
                                    ...
                                    <p class="usr-location">
                                        <span class="badge" :class="getTypeBadgeClass(gift.type)">{{ getTypeLabel(gift.type) }}</span>
                                    </p>
                                </div>
                                <div class="user-phone">
                    ...
                    <!-- Pagination -->
                    <div v-if="!loading && pagination.pages > 1" class="d-flex justify-content-between align-items-center mt-4 px-3 pb-3">
                        ...
                        <nav>
                            <ul class="pagination mb-0">
                                <li class="page-item" :class="{ disabled: pagination.page === 1 }">
                                    <a class="page-link" href="javascript:;" @click="changePage(pagination.page - 1)" :disabled="pagination.page === 1">
                                ...
                                <li class="page-item" :class="{ disabled: pagination.page === pagination.pages }">
                                    <a class="page-link" href="javascript:;" @click="changePage(pagination.page + 1)" :disabled="pagination.page === pagination.pages">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
